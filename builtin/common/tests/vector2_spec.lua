...
describe("vector2", function()
	...
	it("direction()", function()
		...
		assert.same(vector2.new(0, 1), vector2.direction(a, b))
		assert.same(vector2.new(0, 1), a:direction(b))
	end)
	...
	it("normalize()", function()
		...
		assert.same(vector2.new(0, -1), vector2.normalize(a))
		assert.same(vector2.new(0, -1), a:normalize())
		assert.same(vector2.zero(), vector2.normalize(vector2.zero()))
	end)
