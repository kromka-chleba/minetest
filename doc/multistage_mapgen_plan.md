...
- **Overgeneration safety:** When stage N runs on a chunk, all 26 surrounding
  chunks must still be at mapgen stage ≤ N. This guarantees that any data
  generated in the overgenerated padding is either regenerated by, or
  authoritative in, a neighbour that has not yet advanced past the same
  stage.
